                ...
                return (
                    <div className="flex-col gap-8 w-full">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <AgentCard title="PR Optimizer Agent" icon={Target} subtitle="Auto-analyzes project BOQ. Predicts material requirements using ML (trained on 66 EPC + 24 HAM projects). Flags anomalies like duplicates or spec mismatches." valuePoints={['30% faster PR processing', '$5M working capital unlocking', '$1.5M delay cost avoidance']} example="Fortune 500 Infrastructure Client: AI predicted 2,500 MT cement vs manual 3,200 MT for Dallas Highway Expansion project → 22% over-ordering prevented → $35k saved." />
            ...
            case 'hr':
                return (
                    <div className="flex-col gap-8 w-full">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <AgentCard title="Employee Lifecycle Agent" icon={Users} subtitle="Automates onboarding generation, leave deduction calculations (LOP), background verifications via third-party APIs, and final settlement calculations." valuePoints={['$3M HR efficiency value', '$1.5M payroll accuracy', '$1.8M attrition reduction via predictive exit alerts']} example="Manufacturing company: Onboarded 1,200 employees. HR ops team reduced 35 → 12 FTE. Real-time predictive analytics saved 45 at-risk employees." />
                            <AgentCard title="HR Chatbot & Self-Service Agent" icon={CheckCircle2} subtitle="24/7 conversational bot handling 200+ policy queries. Integrates into MS Teams / WhatsApp for instant leave application processing and tax computation." valuePoints={['$600k HR service desk cost savings', '80% query resolution via chatbot', '<2 min avg response time']} example="IT company (4,500 employees): Chatbot handles 18,000 queries/month. HR desk 15 → 4 people. Employee NPS 45 → 78." />
                        </div>
                    </div>
                );
            case 'operations':
                return (
                    <div className="flex-col gap-8 w-full">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <AgentCard title="Project Pulse Agent" icon={Activity} subtitle="Real-time DPR ingestion via OCR and predictive delay alerts based on Random Forest ML trained on historical milestones." valuePoints={['$6M project execution value', '$3.7M early completion bonuses', '$2.4M delay avoidance']} example="Fortune 500 Infrastructure Client: I-35 Expansion Project completed 168 days early → $2.3M bonus. AI tracked critical path bottlenecks 45 days in advance." />
